...
\item [\refstepcounter{mnum} \mthemnum \label{m6}:] Data Processing Module
\item [\refstepcounter{mnum} \mthemnum \label{m7}:] Data Collection Module
\item [\refstepcounter{mnum} \mthemnum \label{m8}:] Machine Learning Module
\item [\refstepcounter{mnum} \mthemnum \label{m9}:] User Interface Module
