...
\begin{figure}[H] 
\centering
\includegraphics[width=\textwidth,height=0.4\textheight,keepaspectratio]{angle_y.PNG} 
\caption{Angled y} 
\label{Fig.Angled y} 
\end{figure}
...
\begin{figure}[H] 
\centering
\includegraphics[width=\textwidth,height=0.4\textheight,keepaspectratio]{lowlight_y.PNG} 
\caption{Low Light y} 
...
\begin{figure}[H] 
\centering
\includegraphics[width=\textwidth,height=0.4\textheight,keepaspectratio]{normal_y.PNG} 
\caption{Normal y} 
\label{Fig.Normal y} 
\end{figure}
...
\begin{figure}[H] 
\centering
\includegraphics[width=\textwidth,height=0.4\textheight,keepaspectratio]{tiltedl_y.PNG} 
\caption{Tilted Left} 
...
\begin{figure}[H] 
\centering
\includegraphics[width=\textwidth,height=0.4\textheight,keepaspectratio]{tiltedr_y.PNG} 
...
\minipage{0.32\textwidth}
  \includegraphics[width=\linewidth]{angle_y.png}
  \caption{Angled y}\label{fig:Angled y}
\endminipage\hfill
\minipage{0.32\textwidth}
  \includegraphics[width=\linewidth]{lowlight_y.png}
...
\endminipage\hfill
\minipage{0.32\textwidth}
  \includegraphics[width=\linewidth]{tiltedl_y.png}
