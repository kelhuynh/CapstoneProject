...
A14 & User testing for different hand sizes and shapes & MLF1, NFR4 & Using different people’s hands to test the accuracy of the string “a”, “”b”, “c”, “d” & Able to translate a b c d everytime & Able to translate a b c d everytime & Pass
\hline
...
\textbf{ID} & \textbf{Description} & \textbf{Req Ref} & \textbf{Input} & \textbf{Expected Output} & \textbf{Actual Output} & \textbf{Result}\\
\hline
B1 & Testing if different webcams or cameras impact coordinates at the same position & CFR1, CFR2 & Sign the sentence “how do you do” alphabet -ically through 5 different cameras & The same set of coordinates for all 5 & The same set of coordinates for all 5 & Pass\\ \hline
...
F3 & Testing hand detection for a series of hand gestures (fast) & CFR1, RDP1, MLFR4 & A series of hand gestures performed in a very fast speed & Letters for correspond -ing hand gestures & Some letters are missing & Fail (need to increase fps)\\ \hline
\newpage
\hline
F4 & Test if gesture for “Speak” does not work when in training mode & RDP2 & Program is started, in training mode, and gestures are performed, then gesture “Speak” is performed & No audio output & No audio output & Pass
\hline
...
\textbf{ID} & \textbf{Description} & \textbf{Req Ref} & \textbf{Input} & \textbf{Expected Output} & \textbf{Actual Output} & \textbf{Result}\\
\hline
H1 & Real-time text display for hand gestures (normal speed) & RDP1 & Hand gestures for “d” and “a” performed in a reasonable speed & Output the correspond -ing letters “d” and “a” besides user’s hand & Output the correspond -ing letters “d” and “a” besides user’s hand & Pass\\ \hline
H2 & Real-time text display for hand gestures (super fast) & RDP1, MLFR4 & Hand gestures performed in a super fast speed & Letters for correspond -ing hand gestures & Some letters output are missing & Fail (need to increase fps)\\ \hline
