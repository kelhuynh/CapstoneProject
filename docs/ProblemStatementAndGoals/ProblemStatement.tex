...
The software part of the sign language translator is a phone application or computer software that has real-time and non-real-time translating functionality. The application or software can identify hand gestures on a real-time basis, or from photos and videos uploaded by the users. The hardware parts consist of a camera, which captures hand gestures, and a hardware system based on Arduino, which does identification and translation processing.
